...
urlpatterns = [
    path('contests/', views.ContestsListAPIView.as_view(), name='contests_list'),
    ...
    path('<int:contest_id>/<int:milestone_id>/<int:task_id>/trials/', views.TrialListAPIView.as_view()),
